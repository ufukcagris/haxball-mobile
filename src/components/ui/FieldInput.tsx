  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <input
        ...
        maxLength={maxLength}
        className={`bg-[var(--surface2)] border-[1.5px] border-[var(--border)] rounded-[9px]
          text-[var(--text)] font-['Exo_2',sans-serif] text-[0.9rem] font-semibold
          py-2 px-3 outline-none transition-all duration-200 w-full
          focus:border-[var(--accent)] focus:shadow-[0_0_0_3px_rgba(0,229,255,0.12)]
